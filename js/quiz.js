...
export default class Quiz {
 ...
 async getQuestions() {
    ...
    if (data.response_code !== 0) {
        throw new Error('No questions available for this selection. Try different options.');
    }
...
buildApiUrl() {
    const params = new URLSearchParams({ amount: this.numberOfQuestions });
  ...
  return `
    <div class="game-card results-card">
      ...
      <div class="action-buttons">
        <button class="btn-restart play-again-btn">
